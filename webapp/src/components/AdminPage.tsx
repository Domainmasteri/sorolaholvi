...
export default function AdminPage(props: AdminPageProps) {
  ...
  useEffect(() => {
    ...
    setEmailTwoFactorEnabled(props.settings.emailTwoFactorEnabled === true);
    setRequireEmailConfirmation(props.settings.requireEmailConfirmation === true);
    ...
    <div className="stack">
      ...
      <section className="card">
        ...
        <div className="stack">
          ...
          <label className="field">
            <span>{t('txt_email_two_factor_enabled')}</span>
            <input
              type="checkbox"
              checked={emailTwoFactorEnabled}
              onChange={(e) => setEmailTwoFactorEnabled((e.currentTarget as HTMLInputElement).checked)}
              disabled={props.loading || props.settingsLoading}
            />
          </label>
          <label className="field">
            <span>{t('txt_require_email_confirmation')}</span>
            <input
              type="checkbox"
              checked={requireEmailConfirmation}
              onChange={(e) => setRequireEmailConfirmation((e.currentTarget as HTMLInputElement).checked)}
              disabled={props.loading || props.settingsLoading}
            />
          </label>
