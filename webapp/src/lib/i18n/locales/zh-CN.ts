...
const zhCN: Record<string, string> = {
  ...
  "txt_from_name": "发件人名称",
  "txt_smtp_host": "SMTP 主机",
  "txt_smtp_port": "SMTP 端口",
  "txt_smtp_username": "SMTP 用户名",
  "txt_smtp_password": "SMTP 密码",
  "txt_email_settings_saved": "邮件设置已保存",
  "txt_email_settings_save_failed": "邮件设置保存失败",
