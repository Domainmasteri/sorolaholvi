...
const ru: Record<string, string> = {
  ...
  "txt_from_name": "Имя отправителя",
  "txt_smtp_host": "SMTP-сервер",
  "txt_smtp_port": "SMTP-порт",
  "txt_smtp_username": "Имя пользователя SMTP",
  "txt_smtp_password": "Пароль SMTP",
  "txt_email_settings_saved": "Настройки электронной почты сохранены",
  "txt_email_settings_save_failed": "Не удалось сохранить настройки электронной почты",
