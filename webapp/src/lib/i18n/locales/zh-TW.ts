...
const zhTW: Record<string, string> = {
  ...
  "txt_email_two_factor_enabled": "電子郵件雙因素驗證",
  "txt_require_email_confirmation": "註冊時需要電子郵件確認",
  "txt_email_delivery_enabled": "啟用郵件傳送",
  "txt_email_settings": "郵件設定",
  "txt_from_email": "寄件人郵箱",
  "txt_from_name": "寄件人名稱",
  "txt_smtp_host": "SMTP 主機",
  "txt_smtp_port": "SMTP 連接埠",
  "txt_smtp_username": "SMTP 使用者名稱",
  "txt_smtp_password": "SMTP 密碼",
  "txt_email_settings_saved": "郵件設定已儲存",
  "txt_email_settings_save_failed": "郵件設定儲存失敗",
